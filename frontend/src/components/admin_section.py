...
from frontend.src.utils.table_helpers import attach_vertical_scrollbar, configure_treeview_columns
...
class UserManagementSection:
    ...
    def setup_ui(self):
        ...
        # 使用者名稱
        self.username_label, self.username_entry, self.username_var = create_labeled_input(
            self.input_frame,
            0,
            "使用者名稱:",
            width=20,
        ...
        # 密碼
        self.password_label, self.password_entry, self.password_var = create_labeled_input(
            self.input_frame,
            1,
            "密碼:",
            width=20,
